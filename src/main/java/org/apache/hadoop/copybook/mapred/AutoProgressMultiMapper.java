 ...
 */
public class AutoProgressMultiMapper<KEYIN, VALIN, KEYOUT, VALOUT> extends CopybookMapper<KEYIN, VALIN, KEYOUT, VALOUT> {

	public static final Log LOG = LogFactory.getLog(AutoProgressMultiMapper.class.getName());
